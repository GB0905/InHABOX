						...
						while (rs.next()) {
							if (rs.getString(4).equals(tfsnName.getText())) {
								...
								if (delrs) {
									...
									File srcfile = new File("images/snack/" + tfsnName.getText() + ".jpeg");
									System.out.println("images/snack/" + tfsnName.getText() + ".jpeg");
	...
	public void mousePressed(MouseEvent e) {
		if(e.getSource() == sntitlebarpn) {
			...
			if (rdAddSn.isSelected()) {
				...
				imglinklbl = "images/Snack/"+tfsnName.getText()+".jpeg";
				snImglbl.setSize(200,250);
				snImglbl.setIcon(resize("images/Snack/"+tfsnName.getText()+".jpeg"));
			}	
		}	
	}
