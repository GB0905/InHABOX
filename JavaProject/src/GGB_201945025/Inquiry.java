			...
			try {
				...
				if (conn != null) {
					...
					if (insrs.next()) {
						...
						JOptionPane.showMessageDialog(main.getRootPane(), "티켓이 조회되었습니다.", "조회", JOptionPane.INFORMATION_MESSAGE);
						...
						JOptionPane.showMessageDialog(main.getRootPane(), "검색 결과가 없습니다.", "조회", JOptionPane.ERROR_MESSAGE);
					}
				} else {
